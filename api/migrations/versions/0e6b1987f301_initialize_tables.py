...
Revision ID: 0e6b1987f301
Revises:
Create Date: 2025-09-26 06:16:01.391065
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_guest", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
    ...
    op.create_index(
        ...
        unique=True,
        postgresql_where=sa.text("user_name IS NOT NULL"),
    )
    op.create_table(
        "identities",
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            postgresql.ENUM("guest", "normal", name="room_kind"),
    ...
    op.create_index(
        op.f("ix_boards_deleted_at"), "boards", ["deleted_at"], unique=False
    )
    op.create_index(
        op.f("ix_boards_deleted_by_id"), "boards", ["deleted_by_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_invitations_deleted_by_id"),
        "invitations",
        ["deleted_by_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_invitations_room_id"), "invitations", ["room_id"], unique=False
    )
    op.create_index(
        "ix_invites_expires_at", "invitations", ["expires_at"], unique=False
    )
    op.create_index(
        "ix_invites_room_codehash",
        "invitations",
        ["room_id", "code_hash"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("owner", "admin", "member", "viewer", name="room_role"),
    ...
    op.create_index(
        "ix_room_members_room_id", "room_members", ["room_id"], unique=False
    )
    op.create_index(
        "ix_room_members_user_id", "room_members", ["user_id"], unique=False
    )
    op.create_table(
        "board_columns",
    ...
    op.create_index(
        op.f("ix_board_columns_deleted_at"),
        "board_columns",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_board_columns_deleted_by_id"),
        "board_columns",
        ["deleted_by_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_columns_board_parent_position",
        "board_columns",
        ["board_id", "parent_id", "position"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        "ix_redemptions_invite", "invite_redemptions", ["invite_id"], unique=False
    )
    op.create_table(
        "swim_lanes",
        sa.Column("board_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_swim_lanes_board_id"), "swim_lanes", ["board_id"], unique=False
    )
    op.create_index(
        op.f("ix_swim_lanes_deleted_at"), "swim_lanes", ["deleted_at"], unique=False
    )
    op.create_index(
        op.f("ix_swim_lanes_deleted_by_id"),
        "swim_lanes",
        ["deleted_by_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_card_assignments_card", "card_assignments", ["card_id"], unique=False
    )
    op.create_index(
        op.f("ix_card_assignments_card_id"),
        "card_assignments",
        ["card_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "kind",
            postgresql.ENUM("twee", "file", "link", name="attachment_kind"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_card_attachments_card_id"),
        "card_attachments",
        ["card_id"],
        unique=False,
    )
    op.create_index(
        "ix_card_attachments_card_kind",
        "card_attachments",
        ["card_id", "kind"],
        unique=False,
    )
    op.create_index(
        op.f("ix_card_attachments_deleted_at"),
        "card_attachments",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_card_attachments_deleted_by_id"),
        "card_attachments",
        ["deleted_by_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["root_id"], ["comments.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(
        "ix_comments_card_created_desc",
        "comments",
        ["card_id", sa.literal_column("created_at DESC")],
        unique=False,
    )
    ...
    op.create_index(
        ...
        "comments",
        ["card_id", "root_id", "parent_id", "created_at"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_comments_deleted_by_id"), "comments", ["deleted_by_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_card_attachments_deleted_by_id"), table_name="card_attachments"
    )
