...
Revision ID: 13efa1e4863e
Revises:
Create Date: 2025-10-10 04:13:43.990325
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "room_type",
            sa.Enum("NORMAL", "GUEST", name="room_type", create_constraint=True),
    ...
    op.create_index(
        ...
        ["expires_at"],
        unique=False,
        postgresql_where=sa.text("room_type = 'GUEST'"),
    )
